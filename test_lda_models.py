...
# ###### File description: This file filters id2word_col and corpus_col and tests the CVs of various configurations
...
print('unpickling')
id2word_col = pickle.load(open(f'{cwd}/pickle/id2word_col.pickle', 'rb'))
corpus_col = pickle.load(open(f'{cwd}/pickle/corpus_col.pickle', 'rb'))
...
def find_cv(num_topic_list, corpus, id2word, save_as, no_above_txt, no_below_txt, alpha=50, plot=True):
    ...
    for num_topic in num_topic_list:
        ...
        model_output = open(f'{cwd}/output/model_output_nobelow_{no_below_txt}_noabove_{no_above_txt}.txt', 'a')
...
def filter_corpus_cv(no_below, no_above, save_as, cv_list = [1,10,20,30,50]):
    ...
    id2word_col = pickle.load(open(f'{cwd}/pickle/id2word_col.pickle', 'rb'))
    texts = pickle.load(open(f'{cwd}/pickle/collated_tweets_lemmatized.pickle', 'rb'))
...
# print(full_corpus_len)

no_above_list = [round(100/full_corpus_len, 6), round(200/full_corpus_len, 6), round(500/full_corpus_len, 6)]
no_below_list = [3,4,5]
