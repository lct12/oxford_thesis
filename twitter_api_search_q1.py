...
def get_tweets(query,start_time,end_time,directory,token):
	...
	params={
			...
			"end_time":end_time, 		"tweet.fields":"attachments,author_id,context_annotations,conversation_id,created_at,entities,geo,id,in_reply_to_user_id,lang,public_metrics,possibly_sensitive,referenced_tweets,source,text,withheld",
...
def main():
	...
	#Find the second Wednesday of January & Feb in the years in the list
	wednesdays=[]
	...
	global_count=0
	keyword_list = ["Harlem", "Bedford Stuyvesant", "Bed Stuy", "Bed-Stuy", "Bushwick", "Clinton Hill", "Boerum Hill", "Prospect Heights", \
	"Stuyvesant Heights", "Crown Heights", "DUMBO", "Williamsburg", "Gowanus", "Greenpoint", "Prospect Park," "Windsor Terrace", "Park Slope", \
	"East Harlem", "Harlem", "East Village", "Inwood", "Morningside Heights", "Washington Heights", "Astoria", "LIC", "Long Island City", "Jackson Heights", \
	"Ravenswood", "Hunters Point", "Sunnyside", "Mott Haven", "Port Morris", "Melrose", "High Bridge", "Mount Eden", "Claremont Village"]
	...
	query=f"bounding_box:[-74.2556782 40.4960342 -74.0492521 40.6488941] OR bounding_box:[-74.0419691 40.5419011 -73.7001809 40.8009249] \
	OR bounding_box: [-74.0472219 40.6839411 -73.9061585 40.8804489] OR bounding_box[-73.9336575 40.7853712 -73.7653293 40.9152598] OR {keyword_query} -is:retweet"
	print(query)
	...
	for day in wednesdays:
		...
		str_endday=datetime(day.year,day.month,day.day+1).strftime("%Y-%m-%d")
